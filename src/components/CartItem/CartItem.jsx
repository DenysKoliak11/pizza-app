...
import { plusCount, minusCount,removeItem } from "../../redux/slices/cartSlice";
import { useDispatch } from "react-redux";

const CartItem = ({ id, title, count, imageUrl, price, type }) => {

    const dispatch = useDispatch();
    const onClickRemove = () => {
        dispatch(removeItem(id));
        alert('Ви справді хочете видалити товар');
    };
    const onClickPlus = () => {
